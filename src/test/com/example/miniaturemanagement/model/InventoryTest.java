...
class InventoryTest {
    ...
    void lookupSetByNameMultipleResults() {
        ObservableList<MiniatureSet> result = Inventory.lookupSet("Pa");
        assertEquals("Double Trouble Surprise Pack", result.get(1).getName());
        assertEquals("A Party of Thieves", result.get(2).getName());
    }
    ...
    void updateMiniature() {
        Miniature mini = Inventory.lookupMiniature(1);
        mini.setName("Update");
        assertEquals("Update", Inventory.lookupMiniature(1).getName());
    }
    ...
    @Test
    void updateCourse() {
        Course update = Inventory.lookupCourse(1);
        update.setName("Update");
        assertEquals("Update", Inventory.lookupCourse(1).getName());
    }
